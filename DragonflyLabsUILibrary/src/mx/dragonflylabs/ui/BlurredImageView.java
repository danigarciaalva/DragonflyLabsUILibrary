...
/**
 * Created by Daniel García Alvarado on 10/3/14.
 */
public class BlurredImageView extends ImageView{

        private int blur_level = 15;
        ...
        private void initAttrs(AttributeSet attrs){
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.BlurredImageView);
            blur_level = a.getInt(R.styleable.BlurredImageView_blurLevel, 15);
            a.recycle();
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            Bitmap blurredBitmap = fastblur(mScaledBitmap, blur_level);
            Log.d("BlurredImageView", "Blur Level: "+blur_level);
